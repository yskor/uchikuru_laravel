...
<body>
    <header>
        ...
        <div class="bg-dark mb-3">
            ...
            <nav class="navbar navbar-expand navbar-dark bg-dark p-0 d-none d-sm-block">
                <div class="container-fluid px-0">
                    <ul class="navbar-nav w-100 nav-justified">
                        ...
                        <li class="nav-item border">
                            <a class="nav-link"
                                href="{{route('buy_list_category', ['consumables_category_code' => 1])}}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <li class="nav-item border">
                            <a class="nav-link" href="{{route('deliver')}}">
                                <svg class="svg-inline--fa fa-hand-holding fa-w-18 menu-icon-size fa-fw"
                                    aria-hidden="true" focusable="false" data-prefix="fas" data-icon="hand-holding"
                        ...
                        <li class="nav-item border">
                            <a class="nav-link"
                                href="{{route('master_list_category', ['consumables_category_code' => 1])}}">
            ...
            <nav class="navbar navbar-expand navbar-dark bg-dark p-0 d-block d-sm-none">
                <div class="container-fluid px-0">
                    <ul class="navbar-nav w-100 nav-justified">
                        {{-- <li class="nav-item border">
                        ...
                        <li class="nav-item border">
                            <a class="nav-link" href="{{route('ship_list')}}" style="font-size: 5px;">
                                <svg class="svg-inline--fa fa-truck fa-w-20 menu-icon-size fa-fw"
                                    style="font-size: 16px" aria-hidden="true" focusable="false" data-prefix="fas"
                                    data-icon="truck" role="img" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <li class="nav-item border">
                            <a class="nav-link" href="{{route('deliver')}}" style="font-size: 5px;">
                                <svg class="svg-inline--fa fa-truck fa-w-20 menu-icon-size fa-fw"
                                    style="font-size: 14px" aria-hidden="true" focusable="false" data-prefix="fas"
                                    data-icon="hand-holding" role="img" xmlns="http://www.w3.org/2000/svg"
