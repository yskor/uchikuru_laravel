	...
	<div class="row mt-3">
		...
		<div class="col-6 col-md-3 user_menu text-center mb-5">
			<a href="{{route('buy_list_category', ['consumables_category_code' => 1])}}">
				<div class="user_menu_icon d-flex align-items-center justify-content-center">
					<svg xmlns="http://www.w3.org/2000/svg" style="font-size: 30px" fill="currentColor" class="svg-inline--fa fa-hand-holding text-white menu-icon-size fa-fw" viewBox="0 0 16 16">
		...
		<div class="col-6 col-md-3 user_menu text-center mb-5">
			<a href="{{route('ship_list')}}">
				<div class="user_menu_icon d-flex align-items-center justify-content-center">
					<svg class="svg-inline--fa fa-truck fa-w-20 text-white menu-icon-size fa-fw" style="font-size: 30px" aria-hidden="true"
