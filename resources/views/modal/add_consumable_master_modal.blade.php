				...
				<div class="modal-body">
					...
					<div class="form-group" id="consumable-code-form-group">
						<label for="consumable-code">消耗品コード (バーコード) <span class="badge bg-danger">必須</span>	</label>
							<input type="text" class="form-control" name="consumable_code" id="consumable-code" required>
					...
					<div class="form-group" id="consumable-name-form-group">
						<label for="consumable-name">消耗品名 <span class="badge bg-danger">必須</span>	</label>
							<input type="text" class="form-control" name="consumable_name" id="consumable-name" required>
					...
					<div class="form-group" id="number-unit-price-form-group">
						<label for="number-unit-price">個数単価	</label>
							<input type="number" class="form-control" name="number_unit_price" id="number-unit-price" required>
					...
					<input class="form-check-input" type="checkbox" name="use_quantity" id="use-quantity" checked="ture" value="1">
					...
					<div class="form-check">
					<input class="form-check-input" type="checkbox" name="can_use_multiple" id="can-use-multiple" value="0">
					...
					<script type="text/javascript">
						...
						<div class="col-md-12">
							<div class="row">
								...
								<div class="col-md-4">
									<select name="consumable_category_code" id="consumable-category-code" class="form-select">
									...
									<div name="consumable-category-code-feedback" id="consumable-category-code-feedback" class="invalid-feedback"></div>
								</div>
							</div>
						</div>
					</div>
					...
					</div>	<div class="form-group" name="last-negotiation-date-form-group" id="last-negotiation-date-form-group">
