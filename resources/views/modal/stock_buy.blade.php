<!-- Modal -->
<div class="modal fade" id="modal-buy-{{$facility->office_code}}-{{$consumables->consumables_code}}" tabindex="-1"
    aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"
                    id="modal-buy-{{$facility->office_code}}-{{$consumables->consumables_code}}-Label">仕入</h5>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="btn-do"><svg
                    ...
                    </svg><!-- <i class="fas fa-plus fa-fw"></i> Font Awesome fontawesome.com -->仕入</button>
            </div>
        </div>
    </div>
</div>