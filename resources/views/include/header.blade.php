...
<div class="bg-light mb-3">
	...
	@if($login->operation_type_code == 'CARE')
	...
	@elseif($login->operation_type_code == 'LABO')
	<nav class="navbar navbar-expand navbar-light bg-light p-0 d-none d-sm-block">
		<div class="container-fluid px-0">
			<ul class="navbar-nav w-100 nav-justified">
				<li class="nav-item border">
				...
				<li class="nav-item border">
					<a class="nav-link" href="{{route('deliver_status', ['consumables_category_code' => 9])}}">
						<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-bar-chart-fill fa-fw" viewBox="0 0 16 16">
							<path d="M1 11a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1v-3zm5-4a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1V7zm5-5a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1V2z"/>
						</svg>
						納品状況
				...
				<li class="nav-item border">
					<a class="nav-link" href="{{route('master_list_category', ['consumables_category_code' => 9])}}">
						<i class="fas fa-database "></i>
						マスタ一覧
					</a>
				</li>
	...
	<nav class="navbar navbar-expand navbar-light bg-light p-0 d-block d-sm-none">
		<div class="container-fluid px-0">
			<ul class="navbar-nav w-100 nav-justified">
				...
				<li class="nav-item border">
					<a class="nav-link" href="{{route('deliver_status', ['consumables_category_code' => 9])}}" style="font-size: 5px;">
						<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-bar-chart-fill fa-fw" style="font-size: 13px" viewBox="0 0 16 16">
							<path d="M1 11a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1v-3zm5-4a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1V7zm5-5a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1V2z"/>
						</svg>
						<br>納品状況
