		...
		<div class="card-body row">
			...
			<div class="col-7">
				...
				<div class="row mb-2">
					...
					<div class="form-group row mb-2" id="consumables-code-form-group">
						<div id="barcode-group-2" style="width: 350px">
							...
							<input type="number" class="form-control" name="barcode[N]" id="consumables-code-2" placeholder="" required>
				...
				<div class="d-flex row mb-2">
					...
					<div class="form-group" id="last-negotiation-date-form-group" style="width: 230px">
				...
				<div class="d-flex row mb-2">
					...
					<div class="" style="width: 180px">
						<label for="">持ち出し数量 <span class="badge bg-danger">必須</span> 
							<a tabindex="0" class="text-danger w-100" role="button" data-bs-toggle="popover" data-bs-trigger="focus" data-bs-content="施設職員がＱＲコードを読み取った際に持ち出す在庫数を入力して下さい">
								<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-info-circle" viewBox="0 0 16 16">
									<path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
									<path d="m8.93 6.588-2.29.287-.082.38.45.083c.294.07.352.176.288.469l-.738 3.468c-.194.897.105 1.319.808 1.319.545 0 1.178-.252 1.465-.598l.088-.416c-.2.176-.492.246-.686.246-.275 0-.375-.193-.304-.533L8.93 6.588zM9 4.5a1 1 0 1 1-2 0 1 1 0 0 1 2 0z"/>
								</svg>
