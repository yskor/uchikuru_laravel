...
<div class="alert alert-danger">
	<h5>権限エラー:</h5>アシスト職員は消耗品を使用できません
</div>
@else
	@if (session('nostock_message'))
	<div class="alert alert-danger">
		{{ session('nostock_message') }}
	</div>
	@else
	<div class="card">
		<form class="" action="{{route('consumption_done')}}" method="post">
			...
			<div id="confirm" class="card-content bg-dark">
				...
				<div class="card-body">
					...
					<div class="d-flex">
						<div>
							<img class="mb-2" id="add_preview" src="{{ asset('upload/consumables/'.$consumables->image_file_extension)}}"
