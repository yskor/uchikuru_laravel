...
<div class="card w-100 mb-3">
    {{-- <div class="card-header">
        <h5 class="w-100">
            {{$consumables_stock->consumables_name}}を{{$consumption_quantity}}{{$consumables->use_unit}}消費しました</h5>
    </div> --}}
    <div class="card-body d-flex">
        <div class="">
            <img src="{{ asset('upload/consumables/'.$consumables_stock->image_file_extension)}}"
        ...
        <h5 class="m-2">
            {{$consumables_stock->consumables_name}}を{{$consumption_quantity}}{{$consumables->use_unit}}持ち出し処理しました</h5>
    </div>
