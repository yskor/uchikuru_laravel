...
<script type="text/javascript" src="{{url('js/uk_ajax.js')}}"></script>
<script type="text/javascript" src="{{url('js/uk_notify.js')}}"></script>
<script type="text/javascript" src="{{url('js/uk_qr.js')}}"></script>
