...
class ConsumablesTable extends BaseTable
{
    ...
    const TABLE_CONSUMABLE_DELIVER_STATUS = "消耗品納品状況テーブル";
    ...
    // 消耗品仕入先マスタ
    public static function viewConsumablesBuyFacility()
    {
        return DB::table(self::VIEW_CONSUMABLE_BUY_FACILITY);
    }
    ...
    // 出荷状況テーブル
    public static function viewConsumablesDeliverStatus()
    {
