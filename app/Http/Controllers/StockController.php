...
class StockController extends AuthController
{
    ...
    //
    /**
     * 事業所のカテゴリ別の消耗品一覧を表示します。
     * @param int $consumables_category_code
     * @return \Illuminate\Contracts\View\View|\Illuminate\Contracts\View\Factory
     */
    public function office_stock_list_category($consumables_category_code, Request $request)
    {
        Log::debug(print_r($this->login, true));
        ...
        // dd($data);  
        return self::view($request, 'office_stock_list_category', $data);
    }
